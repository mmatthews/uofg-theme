...
?>
  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="header"><div class="section clearfix">
      ...
      <?php if ($logo): ?>
        <a href="<?php print $front_page; ?>" title="<?php print t('Go to Homepage'); ?>" rel="home" id="logo">
          <img src="<?php print $logo; ?>" alt="<?php print t('Go to Homepage'); ?>" />
        </a>
      <?php endif; ?>
    ...
    <?php $breadcrumb = false; if ($breadcrumb): ?>
